...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-MissileCommand_MiSTer.git"
CORE_NAME=(Arcade-MissileCommand)
...
UPSTREAM_CORE_NAME=(Arcade-MissileCommand)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-MissileCommand.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-MissileCommand.rbf)
